...
_ASYNC_METHODS = [
    ...
    "push_dockerhub_to_agent",
    "push_dockerhub_all",
    "maybe_push_dockerhub_on_online",
    "push_registry_to_agent",
    "push_registry_all",
    "logout_registry_to_agent",
    "logout_registry_all",
    "maybe_push_registries_on_online",
    "get_aggregated_discovered_registries",
    "stream_start_stack",
    "stream_stop_stack",
